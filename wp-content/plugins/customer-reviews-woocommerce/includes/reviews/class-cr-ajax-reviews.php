...
if (! class_exists('CR_Ajax_Reviews')) :
	...
	class CR_Ajax_Reviews
	{
		...
		public static function get_media_count( $comment_id ) {
			...
			$review_image = get_comment_meta( $comment_id, 'ivole_review_image', false );
			$review_image2 = get_comment_meta( $comment_id, 'ivole_review_image2', false );
			// $review_video = get_comment_meta( $comment_id, 'ivole_review_video', false );
			// $review_video2 = get_comment_meta( $comment_id, 'ivole_review_video2', false );
			...
			$media_count = $review_image + $review_image2;
