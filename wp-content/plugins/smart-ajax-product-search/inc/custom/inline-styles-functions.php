...
function ysm_add_inline_styles_to_stack( $v, $css_id ) {
	...
	if ( isset( $v['settings']['input_icon_bg'] ) ) {
		Ysm_Style_Generator::add_rule( $css_id, array(
			'selectors' => array(
				'.search-submit',
			),
			'props'     => array(
				'background-color' => $v['settings']['input_icon_bg'],
			),
		) );
	}
	...
	if ( isset( $v['settings']['popup_out_of_stock_label_text_color'] ) ) {
		Ysm_Style_Generator::add_rule( $css_id, array(
			'selectors' => array(
				'.smart-search-out-of-stock-label',
			),
			'props'     => array(
				'color' => $v['settings']['popup_out_of_stock_label_text_color'],
			),
		) );
	}

	if ( isset( $v['settings']['popup_out_of_stock_label_bg_color'] ) ) {
		Ysm_Style_Generator::add_rule( $css_id, array(
			'selectors' => array(
				'.smart-search-out-of-stock-label',
			),
			'props'     => array(
				'background-color' => $v['settings']['popup_out_of_stock_label_bg_color'],
			),
		) );
	}

	if ( isset( $v['settings']['popup_sale_label_text_color'] ) ) {
		Ysm_Style_Generator::add_rule( $css_id, array(
			'selectors' => array(
				'.smart-search-sale-label',
			),
			'props'     => array(
				'color' => $v['settings']['popup_sale_label_text_color'],
			),
		) );
	}

	if ( isset( $v['settings']['popup_sale_label_bg_color'] ) ) {
		Ysm_Style_Generator::add_rule( $css_id, array(
			'selectors' => array(
				'.smart-search-sale-label',
			),
			'props'     => array(
				'background-color' => $v['settings']['popup_sale_label_bg_color'],
			),
		) );
	}

	if ( isset( $v['settings']['popup_featured_label_text_color'] ) ) {
		Ysm_Style_Generator::add_rule( $css_id, array(
			'selectors' => array(
				'.smart-search-featured-label',
			),
			'props'     => array(
				'color' => $v['settings']['popup_featured_label_text_color'],
			),
		) );
	}

	if ( isset( $v['settings']['popup_featured_label_bg_color'] ) ) {
		Ysm_Style_Generator::add_rule( $css_id, array(
			'selectors' => array(
				'.smart-search-featured-label',
			),
			'props'     => array(
				'background-color' => $v['settings']['popup_featured_label_bg_color'],
			),
		) );
	}
