<div id="general_tab" class="ymapp-settings__content">
	<table class="form-table">
		...
		ysm_setting( $w_id, 'select_limit', array(
			'type'        => 'text',
			'title'       => __( 'Select Limit for DB Query', 'smart-woocommerce-search' ),
			'description' => __( 'Set number of posts that should be retrieved from the database. This is advanced option, use it only if you know what you do.', 'smart-woocommerce-search' ),
			'value'       => '',
		));
