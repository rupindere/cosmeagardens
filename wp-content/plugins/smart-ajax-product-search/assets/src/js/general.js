		...
		if ( ysm_L10n.enable_search && ysm_L10n.enable_search == 1 ) {
			$( '.widget_search' ).each(function () {
				ysm_init_autocomplete( this, {
					...
					productSlug: ysm_L10n.product_slug,
					maxHeight: ysm_L10n.popup_height,
					...
					preventBadQueries: ysm_L10n.prevent_bad_queries
				} );
			});
		}
		...
		if ( ysm_L10n.enable_product_search && ysm_L10n.enable_product_search == 1 ) {
			$( '.woocommerce.widget_product_search' ).each(function () {
				ysm_init_autocomplete( this, {
					...
					layout: 'product',
					productSlug: ysm_L10n.product_product_slug,
					maxHeight: ysm_L10n.product_popup_height,
					...
					loaderIcon: ysm_L10n.product_loader_icon,
					preventBadQueries: ysm_L10n.product_prevent_bad_queries
				} );
			});
		}
		...
		if ( ysm_L10n.enable_avada_search && ysm_L10n.enable_avada_search == 1 ) {
			$( '.fusion-search-form' ).each(function () {
				ysm_init_autocomplete( this, {
					...
					productSlug: ysm_L10n.avada_product_slug,
			...
			$custom_widgets.each(function () {
				var id   = $( this ).find( 'form' ).data( 'id' ),
					attr = {
						...
						productSlug: ysm_L10n[ 'custom_' + id + '_product_slug' ],
						maxHeight: ysm_L10n[ 'custom_' + id + '_popup_height' ],
						...
						loaderIcon: ysm_L10n[ 'custom_' + id + '_loader_icon' ],
						preventBadQueries: ysm_L10n[ 'custom_' + id + '_prevent_bad_queries' ]
					};
		...
		function ysm_init_autocomplete( el, attr ) {
			...
			$form.on( 'submit', function( e ) {
				...
				if ( val === '' || val.length < options.minChars ) {
					...
					var action = ysm_L10n.searchPageUrl;
