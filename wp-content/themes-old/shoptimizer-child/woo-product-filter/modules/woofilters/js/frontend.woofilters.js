(function ($, app) {
	...
	WpfFrontendPage.prototype.eventsFrontend = (function () {
					...
					if (response['action'] && response['action'] == 'us_ajax_grid') {
						if (response['template_vars'] && response['template_vars'].length) {
							...
							if (query && query['query_args']) {
								...
								if (args['brand']) delete args.brand;
		...
		jQuery('.wpfFilterWrapper[data-filter-type="wpfCategory"], .wpfFilterWrapper[data-filter-type="wpfPerfectBrand"], .wpfFilterWrapper[data-filter-type="wpfBrand"]').each(function() {
	...
	WpfFrontendPage.prototype.filtering = (function ($filterWrapper, clearAll) {
		...
		var $filterSettings = $generalSettings === false ? {} : {
			...
			'use_brand_filtration': $generalSettings['settings']['use_brand_filtration'] ? $generalSettings['settings']['use_brand_filtration'] : 1,
	...
	WpfFrontendPage.prototype.afterAjaxFiltering = (function($wrapperSettings){
		...
		console.log("start yith_wcqv_wcajaxnav_update");
		// for yith quick view
		//jQuery(document).trigger('yith_wcqv_wcajaxnav_update');
        console.log("end yith_wcqv_wcajaxnav_update");
		...
		document.dispatchEvent(customEvent);
		console.log("afterAjaxFiltering");
		
		jQuery("#wpfBlock_4 .wpfFilterVerScroll li").show();
		//jQuery(".wpfFilterWrapper data-filter-type['wpfBrand'] wpfFilterVerScroll li").show();
	});
	...
	WpfFrontendPage.prototype.getFilterOptionsByType = (function($filter, filterType){
		var _thisObj = this.$obj;
		console.log('get' + filterType.replace('wpf', '') + 'FilterOptions');
	...
	WpfFrontendPage.prototype.getBrandFilterOptions = (function ($filter) {
		var _thisObj = this.$obj,
			optionsArray = [],
			frontendOptions = [],
			options = [],
