...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Add on Gift', 'woocommerce' ); ?></th>
				<th class="product-price-custom"><?php esc_html_e( 'Total Price', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td> 
							<?php 
						// Meta data.
						echo wc_get_formatted_cart_item_data( $cart_item, $flat ); // PHPCS: XSS ok.
	...
	<tr>
		...
		<td>
			<a class="cxecrt-cart-page-button" href="https://staging1.cosmeagardens.com/cart/#cxecrt-save-cart" id="cxecrt_dropdown_btn">
					Save &amp; Share Cart</a>
		</td>
	</tr>
	</tbody>
