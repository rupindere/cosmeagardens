...
define('WPF_PLUG_NAME', 'woo-product-filter');
define('WPF_DIR', get_stylesheet_directory() . '/woo-product-filter/');
...
define('WPF_PLUGINS_URL', get_stylesheet_directory_uri());
...
define('WPF_PLUGIN_INSTALLED', false);
